...
### Цели:
  ...
  1. [Создание сети и настройка базовых параметров на устройствах](#1);
  2. [Создать VLAN и назначить на порты коммутатора](#2);
  3. [Настройка Trunk порта между коммутаторами](#3);
  4. [Настройка маршрутизации между  VLAN на роутере](#4);
  5. [Убедиться что маршрутизация между VLAN работает](#5);


###  Решение:
  1. Базовая  конфигурация  Роутера и  Коммутатора: <a id=1></a>
  ...
  2. Создание VLAN и назначения  портов: <a id=2></a>
  ...
  3. Настройка Trunk порта между коммутаторами: <a id=3></a>
  ...
  4. Настройка маршрутизации между  VLAN на роутере: <a id=4></a>
  ...
  5. Убедиться что маршрутизация между VLAN работает: <a id=5></a>
